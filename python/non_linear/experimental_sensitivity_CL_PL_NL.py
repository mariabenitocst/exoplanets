...
def delta_sigma_Tint2(r, M, A, sigma_M, sigma_A, Tint, a, b, b1, c, c1):     
    ...
    """                                                                         
    MA = (                                                                      
    dderivativeT_wrt_AM(r, M, A, a, b, b1, c, Tint, 0., Tint, 1., 1., 1.)*sigma_A**2*
    dderivativeT_wrt_MA(r, M, A, a, b, c, c1, Tint, 0., Tint, 1., 1., 1.)*sigma_M**2
            )                                                                   
    # return                                                                    
    return (0.5*(                                                               
