...
#SBATCH -e /home/mariacst/exoplanets/running/gNFW/baseline_NL/logs/error_BD100_%A_%a.log    
#SBATCH -o /home/mariacst/exoplanets/running/gNFW/baseline_NL/logs/output_BD100_%A_%a.log
#SBATCH --array=1-100
...
N=100
path=/home/mariacst/exoplanets/running/gNFW/baseline_NL/out/
...
do
    ...
    do
        echo $rs
        for gamma in 0.5 0.6 0.7 0.8 0.9 1. 1.1 1.2 1.3 1.4 1.5
        do
            echo $gamma
