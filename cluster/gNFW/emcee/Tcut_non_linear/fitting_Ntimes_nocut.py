...
file_object = open(filepath + ("_N%i_sigma0.01_gamma%.1frs%.1f_nwalkers%i_steps%i_"
...
file_object2 = open(filepath + ("_N%i_sigma0.01_gamma%.1frs%.1f_nwalkers%i_steps%i_"
                    %(nBDs, gamma_true, rs_true, nwalkers, steps))            
                    + "v" + str(rank), "wb")                                  
