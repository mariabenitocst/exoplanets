...
def mock_population(N, relT, relM, relR, relA, f_true, gamma_true, rs_true, 
                    rho0_true=0.42, Tmin=0., v=None):
    """
    ...
    robs_wn = r_obs + np.random.normal(loc=0, scale=(relR*r_obs), size=_N)
    ...
    #return
    return (robs_wn[pos][:N], relR*r_obs[pos][:N],
