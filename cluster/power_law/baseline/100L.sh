...
#SBATCH -e /home/mariacst/exoplanets/running/baseline/logs/error_BD100_%A_%a.log
#SBATCH -o /home/mariacst/exoplanets/running/baseline/logs/output_BD100_%A_%a.log
#SBATCH --array=1-200
...
ex=baseline_log
N=100
path=/home/mariacst/exoplanets/running/baseline/out/log
